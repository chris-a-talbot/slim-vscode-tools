// Global data stores for documentation
...
export function setFunctionsData(data: { [key: string]: FunctionData }): void {
    functionsData = data;
}

export function setClassesData(data: { [key: string]: ClassInfo }): void {
    classesData = data;
}

export function setCallbacksData(data: { [key: string]: CallbackInfo }): void {
    callbacksData = data;
}

export function setTypesData(data: { [key: string]: TypeInfo }): void {
    typesData = data;
}

export function setOperatorsData(data: { [key: string]: OperatorInfo }): void {
    operatorsData = data;
}
