// Position and word context utilities
import { WordInfo, PositionOptions } from '../config/types';
import { TWO_CHAR_OPS, SINGLE_CHAR_OPS, IDENTIFIER_PATTERNS } from '../config/config';
