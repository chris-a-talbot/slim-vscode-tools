...
exports.StringCommentStateMachine = void 0;
exports.expandTypeAbbreviations = expandTypeAbbreviations;
exports.cleanTypeNames = cleanTypeNames;
exports.cleanSignature = cleanSignature;
exports.cleanDocumentationText = cleanDocumentationText;
exports.isEscapedQuote = isEscapedQuote;
exports.parseCodeWithStringsAndComments = parseCodeWithStringsAndComments;
 ...
 */
class StringCommentStateMachine {
    constructor(options = {}) {
        this.options = {
     ...
     */
    processChar(char, prevChar, nextChar, code, position) {
        let skipChar = false;
        let breakLine = false;
     ...
     */
    handleMultiLineComment(char, prevChar, nextChar) {
     ...
     */
    handleSingleLineComment(char, nextChar) {
     ...
     */
    handleString(char, code, position) {
...
exports.StringCommentStateMachine = StringCommentStateMachine;
/**
 ...
 */
function isEscapedQuote(text, position) {
 ...
 */
function parseCodeWithStringsAndComments(code, options = {}, onChar = null, onStateChange = null) {
    ...
    for (let i = 0; i < code.length; i++) {
        ...
        if (breakLine)
            break;
        if (skipChar)
            i++; // Skip next char if we processed a two-char sequence
    }
 ...
 */
function countBracesIgnoringStringsAndComments(line) {
    let openCount = 0;
    let closeCount = 0;
 ...
 */
function countParenthesesIgnoringStringsAndComments(code) {
    let openCount = 0;
    let closeCount = 0;
