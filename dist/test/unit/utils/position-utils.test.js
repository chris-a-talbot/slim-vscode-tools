...
const position_utils_1 = require("../../../src/utils/position-utils");
...
(0, vitest_1.describe)('getOperatorAtPosition', () => {
    ...
    (0, vitest_1.it)('returns single-character operator at cursor', () => {
        (0, vitest_1.expect)((0, position_utils_1.getOperatorAtPosition)(code, pos(0, 2))).toBe('+');
    });
    (0, vitest_1.it)('returns multi-character operator when cursor is anywhere on it', () => {
        (0, vitest_1.expect)((0, position_utils_1.getOperatorAtPosition)(code, pos(1, 3))).toBe('<=');
        (0, vitest_1.expect)((0, position_utils_1.getOperatorAtPosition)(code, pos(2, 3))).toBe('&&');
    });
    (0, vitest_1.it)('returns null when no operator at position', () => {
        (0, vitest_1.expect)((0, position_utils_1.getOperatorAtPosition)(code, pos(0, 0))).toBeNull();
    });
});
(0, vitest_1.describe)('getWordAndContextAtPosition', () => {
    ...
    (0, vitest_1.it)('returns method context when cursor is on method name', () => {
        const info = (0, position_utils_1.getWordAndContextAtPosition)(text, pos(0, 6), {
    ...
    (0, vitest_1.it)('returns instance context when cursor is on object name', () => {
        const info = (0, position_utils_1.getWordAndContextAtPosition)(text, pos(1, 1), {
    ...
    (0, vitest_1.it)('returns plain word when not part of dot expression', () => {
        const info = (0, position_utils_1.getWordAndContextAtPosition)(text, pos(2, 0), {});
...
(0, vitest_1.describe)('getAutocompleteContextAtPosition', () => {
    ...
    (0, vitest_1.it)('detects method/property completion context after dot', () => {
        const info = (0, position_utils_1.getAutocompleteContextAtPosition)(text, pos(0, 4), {
            instanceDefinitions: { obj: 'SomeClass' },
    ...
    (0, vitest_1.it)('returns identifier context when not after dot', () => {
        const info = (0, position_utils_1.getAutocompleteContextAtPosition)(text, pos(1, 2));
        (0, vitest_1.expect)(info).not.toBeNull();
