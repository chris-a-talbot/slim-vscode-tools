...
(0, vitest_1.describe)('type cleaning helpers', () => {
    (0, vitest_1.it)('expands type abbreviations', () => {
        (0, vitest_1.expect)((0, text_1.expandTypeAbbreviations)('Ni Nl Ns Nf Nif Nis is')).toBe('integer logical string float integer or float integer or string integer or string');
    });
    (0, vitest_1.it)('removes singleton $ suffix and expands types', () => {
        (0, vitest_1.expect)((0, text_1.cleanTypeNames)('integer$ object<DataFrame>$ Ni')).toBe('integer object<DataFrame> integer');
    });
    (0, vitest_1.it)('cleans signatures and collapses object<Clazz>', () => {
        (0, vitest_1.expect)((0, text_1.cleanSignature)('object<DataFrame>$ -> Ni')).toBe('<DataFrame> -> integer');
    });
});
(0, vitest_1.describe)('cleanDocumentationText', () => {
    (0, vitest_1.it)('decodes HTML entities and cleans types', () => {
        ...
        const output = (0, text_1.cleanDocumentationText)(input);
...
(0, vitest_1.describe)('StringCommentStateMachine and helpers', () => {
    (0, vitest_1.it)('tracks string state correctly', () => {
        ...
        (0, text_1.parseCodeWithStringsAndComments)(code, {}, (_char, state) => {
    ...
    (0, vitest_1.it)('detects escaped quotes', () => {
        ...
        (0, vitest_1.expect)((0, text_1.removeStringsFromLine)(text)).toMatch(/__STR0__/);
    });
});
(0, vitest_1.describe)('brace and parenthesis counting', () => {
    (0, vitest_1.it)('ignores braces inside strings and comments', () => {
        const line = '"{" // }';
        const counts = (0, text_1.countBracesIgnoringStringsAndComments)(line);
    ...
    (0, vitest_1.it)('counts parentheses outside of strings/comments', () => {
        const code = '("(") // )';
        const counts = (0, text_1.countParenthesesIgnoringStringsAndComments)(code);
...
(0, vitest_1.describe)('removeStringsFromLine', () => {
    (0, vitest_1.it)('replaces strings with stable placeholders', () => {
        const line = 'x = "a" + "b"';
        const result = (0, text_1.removeStringsFromLine)(line);
